...
@pytest.fixture
async def session_token_context(monkeypatch: pytest.MonkeyPatch) -> SessionTokenContextT:
    @wraps(session_token_context)
    @contextmanager
    def __session_token_context(token: str) -> Generator[None]:
    ...
    return __session_token_context
