...
async def _create_witness_vote_operation(pilot: ClivePilot, user: str, approve: bool, expected_witness: str | None = None) -> AccountWitnessVoteOperation:
    ...
    assert text == ("Vote" if approve else "Unvote"), "Expected 'Vote' in witness row!" if approve else "Expected 'Unvote' in witness row!"
