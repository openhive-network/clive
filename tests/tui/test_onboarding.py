...
def assert_working_account(pilot: ClivePilot, name: str) -> None:
    assert pilot.app.world.profile_data.accounts.is_working_account_set(), "Expected working account to be set"
...
def assert_no_working_account(pilot: ClivePilot) -> None:
    assert not pilot.app.world.profile_data.accounts.is_working_account_set(), "Expected no working account"
