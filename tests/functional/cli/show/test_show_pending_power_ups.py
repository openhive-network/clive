...
async def test_power_ups_none(cli_tester: CLITester) -> None:
    # ACT
    result = cli_tester.show_pending_power_ups(account_name="initminer")

    # ASSERT
    assert "no pending power ups" in result.stdout
