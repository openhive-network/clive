...
async def test_transfer_with_beekeeper_session_token(
    node: tt.RawNode,
...
async def test_multiple_transfers_with_beekeeper_session_token(
    node: tt.RawNode,
    cli_tester_with_session_token_unlocked: CLITester,
) -> None:
...
async def test_transfer_with_beekeeper_session_token_and_password_both_set_with_different_wallet_state(
    cli_tester_with_session: CLITesterWithSessionT,
    *,
    unlocked: bool,
) -> None:
    """
...
async def test_transfer_with_beekeeper_either_session_token_or_password_are_missing(
...
async def test_transfer_with_beekeeper_session_token_not_unlocked(
...
async def test_transfer_with_beekeeper_session_token_unlocked_without_sign(
    cli_tester_with_session_token_unlocked: CLITester,
) -> None:
