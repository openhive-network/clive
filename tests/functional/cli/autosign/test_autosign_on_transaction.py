...
async def test_autosign_transaction_with_multiple_keys_in_profile(
    ...
    """Test autosigning succeeds when there are multiple keys in the profile."""
    # ARRANGE
    ...
    # ACT
    result = cli_tester.process_transaction(
        from_file=transaction_file_with_transfer, save_file=signed_transaction_filepath, broadcast=False
    )
