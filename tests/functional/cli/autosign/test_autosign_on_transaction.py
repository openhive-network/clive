...
from clive_local_tools.helpers import create_transaction_file, get_formatted_error_message, get_transaction_filepath
...
def signed_transaction_file_with_transfer(cli_tester: CLITester, transaction_file_with_transfer: Path) -> Path:
    transaction_file_path = get_transaction_filepath("signed_with_transfer")
...
async def test_autosign_transaction(cli_tester: CLITester, transaction_file_with_transfer: Path) -> None:
    ...
    # ARRANGE
    signed_transaction_filepath = get_transaction_filepath("signed")
...
async def test_autosign_is_skipped_with_warning(
    ...
    *,
    ...
    """
    # ARRANGE
    resaved_transaction_filepath = get_transaction_filepath("resaved") if save_to_file else None
