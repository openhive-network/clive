...
EXAMPLE_JSON1: Final[str] = '{"foo": "bar"}'
EXAMPLE_JSON2: Final[str] = '"somestring"'
EXAMPLE_JSON3: Final[str] = "123456.789"
...
@pytest.mark.parametrize("json_", [EXAMPLE_JSON1, EXAMPLE_JSON2, EXAMPLE_JSON3])
...
async def test_json_as_file(cli_tester: CLITester, tmp_path: Path) -> None:
    ...
    json_file.write_text(EXAMPLE_JSON1)
