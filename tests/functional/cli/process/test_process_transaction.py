...
from clive_local_tools.helpers import get_formatted_error_message, get_transaction_filepath
...
def signed_transaction_file_with_transfer(cli_tester: CLITester) -> Path:
    ...
    transaction_filepath = get_transaction_filepath("signed")
...
async def test_load_custom_json_from_file(node: tt.RawNode, cli_tester: CLITester, json_: str) -> None:
    ...
    # ARRANGE
    transaction_filepath = get_transaction_filepath()
...
async def test_multisign_transaction(cli_tester: CLITester, signed_transaction_file_with_transfer: Path) -> None:
    ...
    multisigned_transaction_filepath = get_transaction_filepath("multisig_trx")
...
async def test_override_signature_in_transaction(
    ...
    override_transaction_filepath = get_transaction_filepath("override")
