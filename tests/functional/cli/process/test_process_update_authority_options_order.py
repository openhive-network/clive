...
from clive_local_tools.helpers import get_transaction_filepath
...
async def test_save_file_option_multiple_times(cli_tester: CLITester, authority: AuthorityLevelRegular) -> None:
    # ARRANGE
    not_created_transaction_filepath = get_transaction_filepath("not_created")
    created_transaction_filepath = get_transaction_filepath("created")
