...
class CLITester:
    ...
    def show_pending_power_downs(self, *, account_name: str | None = None, profile_name: str | None = None) -> Result:
        return self.__invoke(["show", "pending", "power-downs"], account_name=account_name, profile_name=profile_name)
    ...
    def show_pending_removed_delegations(self, *, account_name: str | None = None, profile_name: str | None = None) -> Result:
        return self.__invoke(["show", "pending", "removed-delegations"], account_name=account_name, profile_name=profile_name)
