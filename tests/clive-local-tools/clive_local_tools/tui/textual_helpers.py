...
async def _wait_for_accounts_data(pilot: ClivePilot) -> None:
    while (
        not pilot.app.world.profile_data.account_manager.is_tracked_accounts_node_data_available
        or not pilot.app.world.profile_data.account_manager.is_tracked_accounts_alarms_data_available
    ):
