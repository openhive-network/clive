...
clive process savings withdrawal --amount="3 HIVE" --password=alice --sign=alice@active --request-id=12
clive show pending withdrawals
clive process savings withdrawal-cancel --password=alice --sign=alice@active --request-id=12
clive show pending withdrawals
