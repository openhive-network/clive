...
async def test_chain_id_is_retrieved_from_api_if_not_set(
    prepare_beekeeper_wallet_with_session: WalletInfo,
    world: World,
    ...
    await world.commands.sign(transaction=transaction, sign_with=prepare_beekeeper_wallet_with_session.public_key)
