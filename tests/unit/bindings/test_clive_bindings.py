...
def test_load_prepared_bindings() -> None:
    # ARRANGE
    file_path = Path(__file__).parent / "custom_bindings.toml"
    ...
    # ASSERT
    assert loaded_data == raw_data, "loaded bindings should be equal to content of toml file"


def test_load_empty_bindings() -> None:
    # ARRANGE
    file_path = Path(__file__).parent / "empty.toml"
