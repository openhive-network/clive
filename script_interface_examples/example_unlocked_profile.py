...
async def example_script() -> None:
    async with clive_use_unlocked_profile() as clive:
        ...
        transfer = await clive.process.transfer(
            from_account="alice", to_account="gtg", amount="1.000 HIVE", memo="Test transfer"
        ...
        await (
            ...
            .sign_with("alicealias")
            .save_file(path="/workspace/clive_workspace/clive/script_interface_examples/transfer_tx.json")
        )
