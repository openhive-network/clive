...
async def example_sign_with_and_unsign():
    ...
    async with CliveSi().use_unlocked_profile() as clive:
        ...
        transfer1 = (
            ...
            .sign_with("STM5iuVuYcsZmCzXHJT9VbVvHATPa28cLMrf5zKEkzqKc73e22Jtr")
            .as_transaction_object()
        )
...
async def example_all_finalizations():
    ...
    async with CliveSi().use_unlocked_profile() as clive:
        await (
            ...
            .sign_with(key="STM5iuVuYcsZmCzXHJT9VbVvHATPa28cLMrf5zKEkzqKc73e22Jtr")
            .save_file(path="/workspace/clive_workspace/clive/script_interface_examples/test_alice.json")
        )
        ...
        await (
            ...
            .sign_with(key="STM5iuVuYcsZmCzXHJT9VbVvHATPa28cLMrf5zKEkzqKc73e22Jtr")
            .save_file(path="/workspace/clive_workspace/clive/script_interface_examples/test_alice.bin")
        )
        try:
            await (
                clive.process.transfer(
...
async def main():
    ...
    try:
        await example_sign_with_and_unsign()
    except Exception as e:
        print(f"✗ Example 5 failed: {e}")

    try:
        await example_multisign()
    except Exception as e:
