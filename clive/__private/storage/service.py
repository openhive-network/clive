...
class PersistentStorageService:
    def __init__(self, beekeeper: Beekeeper) -> None:
        assert beekeeper.is_running, "Storage service can only be initialized after beekeeper is started."
    ...
    async def save_profile(self, profile: Profile) -> None:
        ...
        encrypted_content = await EncryptWithProfileKey(
