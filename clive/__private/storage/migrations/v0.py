...
class ProfileStorageModel(ProfileStorageBase):
    ...
    tracked_accounts: Sequence[StorageDefinitions.TrackedAccountStorageModel] = []
    known_accounts: list[str] = []  # noqa: RUF012
    key_aliases: list[StorageDefinitions.KeyAliasStorageModel] = []  # noqa: RUF012
    transaction: StorageDefinitions.TransactionStorageModel | None = None
