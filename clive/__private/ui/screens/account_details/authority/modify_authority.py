...
class ModifyAuthorityItem(AuthorityItemBase):
    ...
    is_modified: var[bool] = var(default=False, init=False)
    is_removed: var[bool] = var(default=False, init=False)
...
class ModifyAuthorityTable(AuthorityTableBase):
    ...
    def edit_entry(
        ...
        edited_entry: AuthorityEntryKeyRegular | AuthorityEntryAccountRegular | AuthorityEntryMemo,
    ) -> None:
