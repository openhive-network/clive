...
from clive.__private.core.constants.tui.manage_key_aliases_bindings import ADD_KEY_ALIAS
...
class ManageKeyAliases(BaseScreen):
    ...
    BINDINGS = [
        ...
        Binding(ADD_KEY_ALIAS.key, "new_key_alias", "New alias", id=ADD_KEY_ALIAS.id),
    ]
