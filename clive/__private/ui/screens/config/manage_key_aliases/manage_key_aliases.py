...
from clive.__private.core.constants.tui.bindings import ADD_BUTTON_BINDING_KEY
...
from clive.__private.ui.widgets.buttons import AddButton, CliveButton
...
class ManageKeyAliases(BaseScreen):
    ...
    BINDINGS = [
        ...
        Binding(ADD_BUTTON_BINDING_KEY, "new_key_alias", "New alias"),
    ]
    ...
    def create_main_panel(self) -> ComposeResult:
        yield Center(AddButton(f"Add new alias ({ADD_BUTTON_BINDING_KEY.upper()})"))
