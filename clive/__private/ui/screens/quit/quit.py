...
class Quit(BaseScreen):
    ...
    BINDINGS = [
        CLIVE_PREDEFINED_BINDINGS.glob.quit.create(action="exit_cleanly", description="Quit"),
    ...
    def create_main_panel(self) -> ComposeResult:
        with DialogContainer():
            ...
            yield Static(f"(You can also confirm by pressing {self.app.custom_bindings.glob.quit} again)", id="hint")
