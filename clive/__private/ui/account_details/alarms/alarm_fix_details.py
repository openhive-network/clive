...
ALARM_FIX_DETAILS_MAP: Final[dict[type[AnyAlarm], AlarmFixDetails]] = {
    ...
    RecoveryAccountWarningListed: AlarmFixDetails(
        fix_info=RecoveryAccountWarningListed.FIX_ALARM_INFO,
    ),
    DecliningVotingRightsInProgress: AlarmFixDetails(
        fix_info=DecliningVotingRightsInProgress.FIX_ALARM_INFO,
    ),
    ChangingRecoveryAccountInProgress: AlarmFixDetails(
        fix_info=ChangingRecoveryAccountInProgress.FIX_ALARM_INFO,
    ),
