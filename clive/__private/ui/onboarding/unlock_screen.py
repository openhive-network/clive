...
class SelectProfile(CliveSelect[str], CliveWidget):
    ...
    def __init__(self) -> None:
        ...
        super().__init__(
            ...
            prompt="Select profile to login",
            allow_blank=False,
        )
...
class UnlockScreen(BaseScreen):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self._lock_checkbox = Checkbox("Lock wallet after time")
    ...
    def on_mount(self) -> None:
        self.watch(self._lock_checkbox, "value", self._change_input_state, init=False)
    ...
    async def unlock(self) -> None:
        ...
        lock_after_time = self._lock_checkbox.value
    ...
    def _change_input_state(self) -> None:
        self._lock_after_time_input.display = self._lock_checkbox.value
