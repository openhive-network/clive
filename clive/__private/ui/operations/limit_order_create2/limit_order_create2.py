...
class CurrencySelectorLimitOrderCreate2(CurrencySelector):
...
class LimitOrderCreate2(CartBasedScreen):
    ...
    def __init__(self) -> None:
        ...
        self.__currency_selector_amount_to_sell = CurrencySelectorLimitOrderCreate2()
        self.__currency_selector_base = CurrencySelectorLimitOrderCreate2()
