...
class SaveTransactionToFileDialog(SelectFileBaseDialog):
    def __init__(self, sign_key: PublicKey | None) -> None:
        super().__init__("Choose a file to save the transaction", "Save file")
    ...
    async def _save_transaction_to_file(self) -> bool:
        ...
        if should_be_signed and self.sign_key is None:
