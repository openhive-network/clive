...
class EditMemoEntryDialog(CliveActionDialog[AuthorityEntryMemo | None]):
    ...
    def create_dialog_content(self) -> ComposeResult:
        yield AuthorityEntryMemoInput(value=self._entry_current_value)
    ...
    async def _perform_confirmation(self) -> bool:
        ...
        authority_entry_memo_input_value = authority_entry_memo_input.value_raw
    ...
    def _close_when_confirmed(self) -> None:
        authority_entry_memo_input_value = self.authority_entry_memo_input.value_raw
        new_entry = AuthorityEntryMemo(authority_entry_memo_input_value)
