...
class CliveScreen(Screen[ScreenResultType], CliveWidget):
    ...
    def prevent_action_when_no_accounts_node_data(func: Callable[P, None]) -> Callable[P, None]:
        ...
        def wrapper(*args: P.args, **kwargs: P.kwargs) -> None:
            ...
            if (
                not app_.world.profile_data.account_manager.is_tracked_accounts_node_data_available
                or not app_.world.profile_data.account_manager.is_tracked_accounts_alarms_data_available
            ):
