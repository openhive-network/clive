...
class PathInput(CliveValidatedInput[Path]):
    ...
    Args:
        ...
        value: The initial value of the input, can be a string or a Path.
        ...
        validator_mode: The mode of the path validator to use.
        validate_on: When to validate the input.
        valid_empty: Whether an empty input is considered
