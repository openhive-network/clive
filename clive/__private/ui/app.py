...
class Clive(App[int]):
    ...
    Attributes:
        ...
        AUTO_FOCUS: The element to focus on when the app is loaded.
    ...
    def update_alarms_data_on_newest_node_data(self, *, suppress_cancelled_error: bool = False) -> Worker[None]:
        ...
        Args:
            suppress_cancelled_error: If True, suppresses WorkerCancelled exceptions and does not re-raise them.
