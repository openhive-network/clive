...
class Clive(App[int]):
    ...
    def action_show_help_panel(self) -> None:
        """Overridden textual action to support showing help panel from command palette."""
        self.help_panel_mounted = True

    def action_hide_help_panel(self) -> None:
        """Overridden textual action to support hiding help panel from command palette."""
    ...
    async def watch_help_panel_mounted(self, mounted: bool) -> None:  # noqa: FBT001
        """
        ...
        for screen in self.screen_stack:
            if mounted:
                ...
                help_panel = screen.query_exactly_one(HelpPanel)
                await help_panel.remove()
