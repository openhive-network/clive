...
class Clive(App[int]):
    ...
    BINDINGS = [
        CLIVE_PREDEFINED_BINDINGS.global_.quit.create(action="quit", description="Quit", show=False),
        CLIVE_PREDEFINED_BINDINGS.global_.clear_notifications.create(
            action="clear_notifications", description="Clear notifications", show=False
        ),
        CLIVE_PREDEFINED_BINDINGS.global_.show_help.create(action="help", description="Help", show=False),
        CLIVE_PREDEFINED_BINDINGS.global_.transaction_summary.create(
            action="go_to_transaction_summary", description="Transaction summary", show=False
        ),
        CLIVE_PREDEFINED_BINDINGS.global_.dashboard.create(
            action="go_to_dashboard", description="Dashboard", show=False
        ),
        CLIVE_PREDEFINED_BINDINGS.global_.settings.create(action="go_to_config", description="Config", show=False),
        CLIVE_PREDEFINED_BINDINGS.global_.open_transaction_from_file.create(
