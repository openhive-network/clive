...
class Clive(App[int], ManualReactive):
    ...
    def update_alarms_data_asap(self) -> None:
        ...
        async def _update_alarms_data_asap() -> None:
            ...
            while not self.world.profile_data.account_manager.is_tracked_accounts_node_data_available:
    ...
    async def update_alarms_data(self) -> None:
        accounts = self.world.profile_data.tracked_accounts
    ...
    async def update_data_from_node(self) -> None:
        accounts = self.world.profile_data.tracked_accounts  # accounts list gonna be empty, but dgpo will be refreshed
