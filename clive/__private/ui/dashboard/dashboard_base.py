...
class ActivityStatsButton(DynamicOneLineButtonUnfocusable):
    ...
    def _get_account_asset_value(self) -> Asset.LiquidT:
        ...
        return getattr(self._account.data, f"{asset_name}_{self._activity_type}")  # type: ignore[no-any-return]
...
class ActivityStats(TrackedAccountReferencingWidget):
    def compose(self) -> ComposeResult:
        ...
        yield ActivityStatsButton(self._account, "balance", Asset.Hive, variant="grey-darken")
        ...
        yield ActivityStatsButton(self._account, "balance", Asset.Hbd, variant="grey-lighten")
