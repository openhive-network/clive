...
class DashboardBase(BaseScreen):
    ...
    def __init__(self) -> None:
        ...
        self._previous_watched_accounts = self.profile_data.accounts.watched
    ...
    async def _update_account_containers(self) -> None:
        if (
            ...
            and self.profile_data.accounts.watched == self._previous_watched_accounts
        ):
            return
    ...
    def has_working_account(self) -> bool:
        return self.profile_data.accounts.is_working_account_set()
