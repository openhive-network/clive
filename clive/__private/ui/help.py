...
class Help(BaseScreen):
    ...
    BINDINGS = [
        CLIVE_PREDEFINED_BINDINGS.glob.hide_help.create(action="app.pop_screen", description="Back", key_display="esc"),
        CLIVE_PREDEFINED_BINDINGS.glob.toggle_table_of_contents.create(
