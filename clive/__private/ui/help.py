...
from clive.__private.ui.bindings import CLIVE_PREDEFINED_BINDINGS, GLOBAL_BINDING_TABLE_PLACEHOLDER
...
class Help(BaseScreen):
    ...
    BINDINGS = [
        CLIVE_PREDEFINED_BINDINGS.global_.hide_help.create(
            action="app.pop_screen", description="Back", key_display="esc"
        ),
        CLIVE_PREDEFINED_BINDINGS.global_.toggle_table_of_contents.create(
            action="toggle_table_of_contents", description="Toggle TOC"
        ),
