...
class FormScreen(CliveScreen, Contextual[FormContextT], ABC):
    BINDINGS = [
        CLIVE_PREDEFINED_BINDINGS.form_navigation.previous_screen.create(
            action="previous_screen", description="Previous screen"
        ),
        CLIVE_PREDEFINED_BINDINGS.form_navigation.next_screen.create(action="next_screen", description="Next screen"),
    ]
