...
class AuthorityEntryBase(AuthorityEntriesHolder, Matchable, ABC):
    ...
    @property
    def ensure_regular(self) -> AuthorityEntryRegular:
        assert self.is_account or self.is_key_regular, "Invalid type of entry."
        return cast("AuthorityEntryRegular", self)
...
AuthorityEntryRegular = AuthorityEntryAccountRegular | AuthorityEntryKeyRegular
