...
from clive.__private.core.account_container import KnownAccountContainer, WatchedAccountContainer
from clive.__private.core.account_manager import AccountManager
...
class ProfileData(Context):
    ...
    def __init__(
        ...
        self._accounts = AccountManager(
            None, WatchedAccountContainer(watched_accounts), KnownAccountContainer(known_accounts)
        )

        if working_account is not None:
            self._accounts.set_working_account(working_account)
