...
class InvalidShorthandToTimedeltaError(ShorthandTimedeltaError):
    ...
    Args:
        invalid_input: The invalid shorthand date format that caused the error.
    """
...
def timedelta_to_shorthand_timedelta(td: timedelta) -> str:
    ...
    Raises:
        InvalidTimedeltaToShorthandError: If the input timedelta cannot be represented in shorthand format.
    ...
    Returns:
        Shorthand date string representing the input timedelta.
    """
...
def shorthand_timedelta_to_timedelta(shorthand: str) -> timedelta:
    ...
    Returns:
        An object representing the duration specified by the input shorthand date string.
    """
