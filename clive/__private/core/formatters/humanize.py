...
def align_to_dot(*strings: str, center_to: int | str | None = None) -> list[str]:
    ...
    Args:
        *strings: A variable number of strings to align.
        center_to: An integer or string representing the length to center the longest string.

    Returns:
        A list of strings aligned to the dot.
    """
...
def humanize_hive_power(value: Asset.Hive, *, use_short_form: bool = True, show_symbol: bool = True) -> str:
    ...
    Args:
        value: An instance of Asset.Hive representing the hive power.
        use_short_form: Whether to use a short form.
        show_symbol: Whether to show the HP symbol.

    Returns:
        A human-readable string representing the hive power.
    """
...
def humanize_hive_power_with_comma(hive_power: Asset.Hive, *, show_symbol: bool = True) -> str:
    ...
    Args:
        hive_power: An instance of Asset.Hive representing the hive power.
        show_symbol: Whether to show the HP symbol.

    Returns:
        A human-readable string representing the hive power with commas.
    """
    symbol = "HP" if show_symbol else ""
...
def humanize_hbd_exchange_rate(hbd_exchange_rate: HbdExchangeRate, *, with_label: bool = False) -> str:
    ...
    Args:
        hbd_exchange_rate: An instance of HbdExchangeRate containing the exchange rate.
        with_label: Whether to add a label to the output.

    Returns:
        A human-readable string representing the HBD exchange rate.
    """
...
def humanize_hbd_savings_apr(hbd_savings_apr: Decimal, *, with_label: bool = False) -> str:
    ...
    Args:
        hbd_savings_apr: A Decimal representing the HBD savings APR.
        with_label: Whether to add a label to the output.

    Returns:
        A human-readable string representing the HBD savings APR.
    """
...
def humanize_hbd_print_rate(hbd_print_rate: Decimal, *, with_label: bool = False) -> str:
    ...
    Args:
        hbd_print_rate: A Decimal representing the HBD print rate.
        with_label: Whether to add a label to the output.

    Returns:
        A human-readable string representing the HBD print rate.
    """
...
def humanize_apr(data: HpAPRProtocol | Decimal) -> str:
    ...
    Args:
        data: An instance of HpAPRProtocol or a Decimal representing the APR value.

    Returns:
        A human-readable string representing the APR value.
    """
...
def humanize_hp_vests_apr(data: HpAPRProtocol | Decimal, *, with_label: bool = False) -> str:
    ...
    Returns:
        A human-readable string representing the APR value with an optional label.
    """
...
def humanize_median_hive_price(current_price_feed: PriceFeed, *, with_label: bool = False) -> str:
    ...
    Args:
        current_price_feed: An instance of PriceFeed containing the current price.
        with_label: Whether to add a label to the output.

    Returns:
        A human-readable string representing the median hive price.
    """
...
def humanize_current_inflation_rate(head_block_number: int, *, with_label: bool = False) -> str:
    ...
    Returns:
        A human-readable string representing the current inflation rate.
    """
...
def humanize_participation_count(participation_count: int, *, with_label: bool = False) -> str:
    ...
    Args:
        participation_count: An integer representing the participation count.
        with_label: Whether to add a label to the output.

    Returns:
        A human-readable string representing the participation count percentage.
    """
...
def humanize_vest_to_hive_ratio(
    ...
    Args:
        data: An instance of TotalVestingProtocol or a Decimal representing the vest to hive ratio.
        with_label: Whether to add a label to the output.
        show_symbol: Whether to show the VEST symbol.

    Returns:
        A human-readable string representing the vest to hive ratio.
    """
...
def humanize_witness_status(signing_key: str) -> str:
    ...
    Returns:
        A string indicating whether the witness is "active" or "inactive".
    """
...
def humanize_votes_with_suffix(votes: int, data: TotalVestingProtocol) -> str:
    ...
    Args:
        votes: An integer representing the number of votes.
        data: An instance of TotalVestingProtocol containing vesting data.

    Returns:
        A human-readable string representing the votes converted to hive power with suffix.
    """
...
def humanize_votes_with_comma(votes: int, data: TotalVestingProtocol) -> str:
    ...
    Returns:
        A human-readable string representing the votes converted to hive power with commas.
    """
    hive_power = calculate_witness_votes_hp(votes, data)
...
def humanize_manabar_regeneration_time(regeneration_time: timedelta) -> str:
    ...
    Args:
        regeneration_time: A timedelta object representing the regeneration time.

    Returns:
        A human-readable string indicating the regeneration time or if it is full.
    """
