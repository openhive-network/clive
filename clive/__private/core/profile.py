...
class Profile:
    ...
    def __init__(  # noqa: PLR0913
        ...
        *,
        ...
        self._transaction_expiration: timedelta = TRANSACTION_EXPIRATION_TIMEDELTA_DEFAULT
    ...
    def set_chain_id(self, value: str | None) -> None:
        ...
        Raises:
            InvalidChainIdError: If the format of the provided chain ID is wrong.
        """
    ...
    def reset_transaction_expiration(self) -> None:
        """Reset the transaction expiration to the default."""
        self._transaction_expiration = TRANSACTION_EXPIRATION_TIMEDELTA_DEFAULT
