...
class Commands[WorldT: World]:
    ...
    async def retrieve_escrow_data(self, *, account_name: str) -> CommandWithResultWrapper[EscrowData]:
        from clive.__private.core.commands.data_retrieval.escrow_data import EscrowDataRetrieval  # noqa: PLC0415
