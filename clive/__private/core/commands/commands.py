...
class Commands[WorldT: World]:
    ...
    async def encrypt_memo_from_accounts(
        ...
        Raises:
            AccountNotFoundForEncryptionError: If either account is not found on the blockchain.
        """
        from clive.__private.core.commands.encrypt_memo_from_accounts import EncryptMemoFromAccounts  # noqa: PLC0415

        return await self.__surround_with_exception_handlers(
            EncryptMemoFromAccounts(
                unlocked_wallet=self._world.beekeeper_manager.user_wallet,
                content=content,
