...
class ChainDataRetrieval(CommandDataRetrieval[HarvestedDataRaw, SanitizedData, ChainData]):
    ...
    async def _process_data(self, data: SanitizedData) -> ChainData:
        return ChainData(
            ...
            current_inflation_rate=calculate_current_inflation_rate(data.gdpo.head_block_number.value),
            hardfork_version=data.hardfork_properties.current_hardfork_version,
            hbd_print_rate=hive_percent_to_percent(data.gdpo.hbd_print_rate.value),
            hbd_savings_apr=hive_percent_to_percent(data.gdpo.hbd_interest_rate.value),
            ...
            participation=data.gdpo.participation_count.value,
