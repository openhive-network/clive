...
if TYPE_CHECKING:
    from clive.__private.models.schemas import Account, AccountName, Authority
...
class CliveAuthorityDataProvider(IAuthorityDataProvider):
    ...
    async def get_hive_authority_data(self, name: AccountName) -> WaxAccountAuthorityInfo:
        ...
        return WaxAccountAuthorityInfo(
            ...
            last_owner_update=cast("HiveDateTime", self._account_data.last_owner_update),
            previous_owner_update=cast("HiveDateTime", self._account_data.previous_owner_update),
        )
