...
class OrderInfo:
    ...
    created: datetime
    expiration: datetime
    original_sell_asset: Asset.LiquidT
    original_receive_asset: Asset.LiquidT
    ...
    def from_fundament(cls, fundament: LimitOrdersFundament) -> OrderInfo:
        ...
        # The base is what's being sold (the original amount)
        # The quote is what's being received (the original min to receive)
        # base and quote are already AssetHive or AssetHbd instances (same as Asset.Hive/Asset.Hbd)
        original_sell_asset = cast("Asset.LiquidT", base)
        original_receive_asset = cast("Asset.LiquidT", quote)
        ...
        receive_amount = int(quote_amount * ratio)
        ...
        return cls(
            ...
            original_sell_asset=original_sell_asset,
            original_receive_asset=original_receive_asset,
