...
class TUIWorld(World, CliveDOMNode):
    ...
    def _update_profile_related_reactive_attributes(self) -> None:
        ...
        self.node_reactive = self._node  # type: ignore[assignment] # ignore that, profile_reactive shouldn't be accessed before unlocking
        self.profile_reactive = self._profile  # type: ignore[assignment] # ignore that, node_reactive shouldn't be accessed before unlocking
