...
class AccountManager:
    ...
    Args:
        working_account: The account to set as working account. If not provided, no working account will be set.
        watched_accounts: Iterable of accounts to be added to the watched accounts.
        known_accounts: Iterable of accounts to be added to the known accounts.
    """
    ...
    def get_tracked_account(self, value: str | Account) -> TrackedAccount:
        ...
        Args:
            value: The name of the account to get. Can be either a string or an Account instance.

        Raises:
            AccountNotFoundError: If given account wasn't found.

        Returns:
            The tracked account with the given name, which can be either a WorkingAccount or WatchedAccount.
        """
