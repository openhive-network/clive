...
TRANSACTION_EXPIRATION_MAX_SECONDS: Final[int] = 86400  # 24h, HIVE_MAX_TIME_UNTIL_SIGNATURE_EXPIRATION
TRANSACTION_EXPIRATION_TIMEDELTA_MAX: Final[timedelta] = timedelta(seconds=TRANSACTION_EXPIRATION_MAX_SECONDS)
