...
UNLOCK_CREATE_PROFILE_HELP: Final[str] = (
    ...
    "`clive configure profile create --profile-name PROFILE_NAME` and pass password to the standard input."
)
...
WEIGHT_MARK: Final[str] = "="
KEY_OR_ACCOUNT_WITH_WEIGHT_METAVAR: Final[str] = (
    f"SUBCOMMAND/KEY[{WEIGHT_MARK}WEIGHT]/ACCOUNT[{WEIGHT_MARK}WEIGHT]\nExamples:\n"
    "STM1111111111111111111111111111111114T1Anm\n"
    f"STM1111111111111111111111111111111114T1Anm{WEIGHT_MARK}2\n"
    f"alice{WEIGHT_MARK}2"
)
SUBCOMMAND_OR_KEY_OR_ACCOUNT_WITH_WEIGHT_METAVAR: Final[str] = (
    f"{KEY_OR_ACCOUNT_WITH_WEIGHT_METAVAR}\n"
    "Subcommands:\nowner\nactive\nposting\nmemo"
)
