...
from beekeepy._remote_handle.settings import Settings as CommunicationSettings
...
class SafeSettings:
    ...
    class _Node(_Namespace):
        ...
        def settings_factory(self, http_endpoint: HttpUrl) -> CommunicationSettings:
            communication_settings = CommunicationSettings(http_endpoint=http_endpoint)
