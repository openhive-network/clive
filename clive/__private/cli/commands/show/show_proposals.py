...
from clive.__private.core.formatters.humanize import humanize_amount, humanize_datetime
...
class ShowProposals(WorldBasedCommand):
    ...
    async def _run(self) -> None:
        ...
        table.add_column("daily\npay", justify="right", style="green", overflow="fold")
        ...
        for proposal in proposals_chunk:
            table.add_row(
                ...
                f"{proposal.votes}",
                f"{humanize_amount(proposal.daily_pay)}",
