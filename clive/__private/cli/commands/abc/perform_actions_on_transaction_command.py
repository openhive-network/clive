...
from clive.__private.visitors.operation.unknown_account_visitor import UnknownAccountsCollector
...
class PerformActionsOnTransactionCommand(WorldBasedCommand, ABC):
    ...
    async def _validate_unknown_accounts(self) -> None:
        ...
        visitor = UnknownAccountsCollector(self.profile)
        transaction_ensured.accept(visitor)
        if visitor.unknown_accounts:
            raise CLITransactionUnknownAccountError(visitor.unknown_accounts)
