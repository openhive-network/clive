...
from clive.__private.core.commands.autosign import InsufficientKeysAutoSignError
    ...
    async def _run(self) -> None:
        ...
        with typer_echo_warnings(AutoSignSkippedWarning, AutoSignSkippedWarningCLI()):
            try:
                ...
                if isinstance(error.error, InsufficientKeysAutoSignError):
                    raise CLIInsufficientKeysAutoSignError from None
                raise
