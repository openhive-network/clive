...
if TYPE_CHECKING:
    ...
    from clive.__private.cli.types import AccountCreationPositionalArgument, KeyOrAccountWithWeight
...
def account_creation_subcommand_or_authority_entry(raw: str) -> AccountCreationPositionalArgument:
    raw, weight = _parse_with_weight(raw, DEFAULT_AUTHORITY_WEIGHT)
    if len(raw) <= 15:  #  noqa: PLR2004 TODO: perform better validation here maybe there is regex in schemas for this
        return raw, weight
    try:
