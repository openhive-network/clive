...
class PerformTransactionCommon(CommonBaseModel):
    """Common options for commands that perform transactions."""
    ...
    def update_forwards() -> None:
        ...
        PerformTransactionCommon.update_forward_refs(**locals())
