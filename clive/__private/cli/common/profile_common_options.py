...
class ProfileCommonOptionsWithPositionalName(CommonOptionsBase):
    profile_name: Optional[str] = arguments.profile_name_argument
    profile_name_option: Optional[str] = argument_related_options.profile_name_argument_related_option
