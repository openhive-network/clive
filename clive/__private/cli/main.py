...
async def call_api(
    ...
    params: str = typer.Argument(
        ...
        metavar="""'{"param": "value", "param2": value2"}'""",
    ),
    ...
    Examples:
    clive call database_api get_dynamic_global_properties
    clive call account_history_api get_account_history '{"account": "temp"}'
    """
    from clive.__private.cli.commands.call import Call  # noqa: PLC0415
