...
async def call_api(
    ...
    """
    from clive.__private.cli.commands.call_api import CallAPIUseNodeAddress, CallAPIUseProfile  # noqa: PLC0415

    if node_address is None:
        await CallAPIUseProfile(
            api_name=api_name,
            method_name=method_name,
            params=params,
        ).run()
    else:
        await CallAPIUseNodeAddress(
            api_name=api_name,
            method_name=method_name,
            params=params,
