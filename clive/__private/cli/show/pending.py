...
@pending.command(name="withdrawals", param_groups=[WorldWithoutBeekeeperOptionsGroup])
...
@pending.command(name="power-ups", param_groups=[WorldWithoutBeekeeperOptionsGroup])
...
@pending.command(name="power-down", param_groups=[WorldWithoutBeekeeperOptionsGroup])
...
@pending.command(name="removed-delegations", param_groups=[WorldWithoutBeekeeperOptionsGroup])
