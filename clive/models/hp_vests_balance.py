...
class HpVestsBalance:
    ...
    @classmethod
    def create(cls, vests_value: Asset.Vests, gdpo: DynamicGlobalProperties) -> HpVestsBalance:
        return cls(hp_balance=vests_to_hive(vests_value, gdpo), vests_balance=vests_value)
